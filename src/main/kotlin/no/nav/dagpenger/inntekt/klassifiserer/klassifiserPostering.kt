...
fun klassifiserPostering(posteringsType: PosteringsType) =
    when {
...
private fun isDagpenger(posteringsType: PosteringsType) =
    posteringsType == PosteringsType.Y_DAGPENGER_VED_ARBEIDSLØSHET

private fun isSykepenger(posteringsType: PosteringsType) = posteringsType == PosteringsType.Y_SYKEPENGER
